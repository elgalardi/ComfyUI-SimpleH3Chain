...
class SimpleH3ChainPlan(_chain.MiniMaxH3ChainPlan):
    ...
    def _context_configuration(prompt):
        ...
        return unique[0] if unique else ("cut", "video", "match_video")
    ...
    def build(
        ...
        fingerprint = (
            ...
            f"audio_context={audio_context_frames}"
        )
        result = super().build(
...
class SimpleH3ChainContext(_chain.MiniMaxH3ChainContext):
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "context_type": (["video", "images", "cut_reference"], {
                    "default": "video",
                    "tooltip": (
                        "video encodes the selected tail as a temporal window. "
                        ...
                        "independently with audio_context_frames."
                    ),
                }),
            },
            "optional": {
    ...
    def apply(
        ...
        audio_context_frames, context_type, audio_vae=None,
    ):
        cut_reference = context_type == "cut_reference"
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "SimpleH3ChainContext": "Simple H3 Context — Video / Images / Cut Reference",
