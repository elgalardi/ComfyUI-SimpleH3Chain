        ...
        return {
            ...
            "optional": {
                "plan_json_input": ("STRING", {
                    "forceInput": True,
                    "tooltip": "Optional external story plan JSON. When connected, it overrides the visual editor JSON.",
                }),
            },
        }
...
class MiniMaxH3ChainLoopEnd:
    ...
    def _recurse(self, flow, next_state, dynprompt, unique_id):
        ...
        compatible_start_types = {
            "MiniMaxH3ChainLoopStart",
            "SimpleH3ChainLoopStart",
        }
        if start_info["class_type"] not in compatible_start_types:
